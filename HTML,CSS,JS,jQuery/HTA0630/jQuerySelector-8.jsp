...
<div class="container">
	...
	<ul id="list-site-favorite">
		...
		<li><a href="http://www.jhta.co.kr">중앙HTA학원</a></li>	
	</ul>
	...
	<h3>SNS 사이트</h3>
	<ul id="list-site-sns">
		<li><a href="https://instagram.com">인스타그램</a>
		<li><a href="https://www.facebook.com">페이스북</a>
	</ul>
	...
	<div id="checkboxs">
		...
		<input type="checkbox" id='search-opt-skill-4' name="skill" value="data"/>빅데이터
