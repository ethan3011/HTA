...
<script type="text/javascript">
	// 링크들을 작동 안하게 설정할때 사용한다. preventDefault()나 return false를 사용할 수 있다.
	$('#box a').click(function(event){
		...
		// 이벤트가 발생한 엘리먼트의 조상 엘리먼트 중에서 div인것 -> <div id="box"> , <div id="container">
		console.log('$(this).parents("div")',$(this).parents('div'));
		
		// 이벤트가 발생한 엘리먼트의 조상 엘리먼트 중에서 아이디가 box 인것 -> <div id="box">
		console.log('$(this).parents("#box")',$(this).parents('#box'));
		
		// 이벤트가 발생한 엘리먼트의 조상 엘리먼트 중에서 가장 가까운 div 인것 -> <div id="box>"
